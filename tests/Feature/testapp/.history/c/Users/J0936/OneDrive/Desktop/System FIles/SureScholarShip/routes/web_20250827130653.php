...
Route::get('/dashboard', [\App\Http\Controllers\DashboardController::class, 'index'])->name('dashboard');
    ...
    Route::get('/scholarship-management', [\App\Http\Controllers\ScholarshipController::class, 'index'])->name('scholarship.management');
    Route::post('/scholarship-management', [\App\Http\Controllers\ScholarshipController::class, 'store'])->name('scholarship.management.store');
    Route::put('/scholarship-management/{id}', [\App\Http\Controllers\ScholarshipController::class, 'update'])->name('scholarship.management.update');
    Route::delete('/scholarship-management/{id}', [\App\Http\Controllers\ScholarshipController::class, 'destroy'])->name('scholarship.management.destroy');
    ...
    Route::post('/disbursements/{id}/release', [\App\Http\Controllers\DisbursementController::class, 'release'])->name('disbursements.release');

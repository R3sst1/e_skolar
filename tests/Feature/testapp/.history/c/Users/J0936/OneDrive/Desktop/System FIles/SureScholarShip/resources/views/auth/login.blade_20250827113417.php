                    ...
                    <form method="POST" action="{{ route('login') }}" class="intro-x mt-8">
                        ...
                        <div class="relative w-full mt-4">
                                ...
                                <input id="password" name="password" type="password"
                                        class="intro-x login__input form-control py-3 px-4 pr-10 block w-full"
            ...
            <script>
                function toggleLoginPassword() {
                    ...
                    const eyeIcon = document.getElementById("eyeIcon");
                        ...
                        // Refresh Lucide icons after swapping
                        lucide.createIcons();
                        }

                    // Make sure Lucide initializes all icons on page load

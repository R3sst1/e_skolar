...
class ResidenceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('residence.index', compact('results', 'q'));
    }
    ...
    public function show($id)
    {
        ...
        return view('residence.show', compact('demographic'));
    }
    ...
    public function createAccountRedirect($id)
    {
        ...
        // Redirect to account creation with demographic data
        return redirect()->route('residence-data.create-account', ['demographic_id' => $id])

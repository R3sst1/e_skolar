...
class AccountController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Debug: Log the user count and search term
        \Log::info('AccountController: Found ' . $users->count() . ' users, search term: "' . $search . '"');

        if ($request->ajax()) {
            return view('dashboardcontent.accounts._users_list', compact('users', 'search'))->render();
        }

        return view('dashboardcontent.accounts.accounts', compact('users', 'search'));
    }

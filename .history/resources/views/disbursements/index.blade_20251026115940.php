...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        ...
        <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
            <a href="{{ route('disbursements.allocation-logs') }}" class="btn btn-outline-secondary shadow-md mr-2" onclick="console.log('View Logs clicked, navigating to: {{ route('disbursements.allocation-logs') }}')">

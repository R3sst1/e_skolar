        ...
        <div class="box p-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="text-center">
                    <div class="text-3xl font-bold text-primary mb-2">₱{{ number_format($totalAllocated ?? 0, 2) }}</div>
                    <div class="text-slate-600">Total Allocated Budget</div>
                    <div class="text-sm text-slate-500 mt-1">From E-Kalinga System</div>
                </div>
                <div class="text-center">
                    <div class="text-3xl font-bold text-warning mb-2">₱{{ number_format($totalDisbursed ?? 0, 2) }}</div>
                    <div class="text-slate-600">Total Disbursed</div>
                    <div class="text-sm text-slate-500 mt-1">Amount Released to Scholars</div>
                </div>
                <div class="text-center">
                    <div class="text-3xl font-bold {{ ($remainingBalance ?? 0) > 0 ? 'text-success' : 'text-danger' }} mb-2">
                        ₱{{ number_format($remainingBalance ?? 0, 2) }}
                    </div>
                    <div class="text-slate-600">Remaining Balance</div>
                    <div class="text-sm text-slate-500 mt-1">Available for Disbursement</div>
                </div>
            </div>

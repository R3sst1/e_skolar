    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="flex gap-2">
                    <button id="fullscreen-grade-btn" class="btn btn-outline-secondary btn-sm" title="Fullscreen">
...
<div id="fullscreen-grade-modal" class="fixed inset-0 bg-black bg-opacity-90 z-50 hidden">
    <div class="flex items-center justify-center h-full">
        <div class="relative max-w-full max-h-full p-4">
            <div class="flex justify-end mb-4">
                <button id="exit-fullscreen-grade" class="btn btn-outline-light btn-sm">
...
function toggleFullscreen() {
    const fullscreenModal = document.getElementById('fullscreen-grade-modal');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const exitFullscreenBtn = document.getElementById('exit-fullscreen-grade');

    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ $isFromDemographic ? route('residence.index') : route('residence-data.index') }}" class="btn btn-outline-secondary">
                    <i data-lucide="arrow-left" class="w-4 h-4 mr-2"></i> Back to {{ $isFromDemographic ? 'Residence Search' : 'Applications' }}
                </a>
            </div>
        </div>
        ...
        <div class="max-w-2xl mx-auto">
            <div class="box p-6">
                <form wire:submit.prevent="createAccount">
                    ...
                    <div class="mb-6">
                        <h3 class="text-lg font-semibold text-slate-800 mb-4">Applicant Information</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="form-label">Full Name</label>
                                <input type="text" value="{{ $residenceData->full_name ?? 'N/A' }}" class="form-control" readonly>
                            </div>
                            <div>
                                <label class="form-label">Contact Number</label>
                                <input type="text" value="{{ $residenceData->contact_number ?? 'N/A' }}" class="form-control" readonly>
                            </div>
                        </div>
                    </div>

...
<div class="content">
    ...
    <!-- Demographic Information (if creating from residence data) -->
    @if($isFromDemographic && $demographicData)
        ...
        <div class="px-5 pb-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                <div>
                    ...
                    <div class="font-medium">{{ $demographicData->full_name ?? 'N/A' }}</div>
                </div>
                <div>
                    <span class="text-slate-500">Contact Number:</span>
                    <div class="font-medium">{{ $demographicData->geographicIdentification->contact_number ?? 'N/A' }}</div>
                </div>
                <div>
                    <span class="text-slate-500">Email:</span>
                    <div class="font-medium">{{ $demographicData->geographicIdentification->email_address ?? 'N/A' }}</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="intro-y box px-5 pt-5 mt-5">
        <div class="px-5 pb-5">
            <form method="POST" action="{{ route('accounts.store') }}">
                ...
                <!-- Hidden field for demographic ID -->
                @if($isFromDemographic && $demographicData)
                    <input type="hidden" name="demographic_id" value="{{ $demographicData->id }}">
                @endif
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="text" 
                                   id="first_name"
                                   name="first_name" 
                                   value="{{ old('first_name', $isFromDemographic ? $demographicData->first_name : '') }}"
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   id="middle_name"
                                   name="middle_name" 
                                   value="{{ old('middle_name', $isFromDemographic ? $demographicData->middle_name : '') }}"
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   id="last_name"
                                   name="last_name" 
                                   value="{{ old('last_name', $isFromDemographic ? $demographicData->last_name : '') }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   id="username"
                                   name="username" 
                                   value="{{ old('username', $isFromDemographic ? strtolower(str_replace(' ', '', $demographicData->first_name . $demographicData->last_name)) : '') }}"
                        ...
                        <div>
                            ...
                            <input type="email" 
                                   id="email"
                                   name="email" 
                                   value="{{ old('email', $isFromDemographic ? $demographicData->geographicIdentification->email_address : '') }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        ...
                        <div>
                            ...
                            <select id="role" 
                                ...
                                <option value="applicant" {{ old('role', 'applicant') == 'applicant' ? 'selected' : '' }}>Applicant</option>
                            </select>
                            @error('role') 
                                <div class="text-danger text-sm mt-1">{{ $message }}</div> 
                            @enderror
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   id="phone_number"
                                   name="phone_number" 
                                   value="{{ old('phone_number', $isFromDemographic ? $demographicData->geographicIdentification->contact_number : '') }}"
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   id="barangay"
                                   name="barangay" 
                                   value="{{ old('barangay', $isFromDemographic ? $demographicData->geographicIdentification->barangay->name : '') }}"
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   id="age"
                                   name="age" 
                                   value="{{ old('age', $isFromDemographic ? $demographicData->age : '') }}"

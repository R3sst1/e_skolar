                ...
                <div class="flex justify-between">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-medium">
                            @if(is_object($demographic->sex) && $demographic->sex->name)
                                {{ $demographic->sex->name }}
                            @elseif($demographic->sex)
        ...
        <div class="box p-6">
            ...
            @else
                <div class="flex items-center justify-between p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <a href="{{ route('residence-data.create-account', $demographic->id) }}" class="btn btn-sm btn-primary">

                            ...
                            <td class="border-b border-slate-100 py-4 px-4 text-center">
                                <div class="flex justify-center items-center gap-2">
                                    ...
                                    <a href="{{ route('residence-data.show', $demographic->id) }}" 
                                       class="btn btn-sm bg-blue-500 hover:bg-blue-600 text-white px-3 py-2 rounded-md transition-colors duration-200 flex items-center gap-1"
                                    ...
                                    @if($existingUser)
                                        <span class="px-3 py-2 bg-green-100 text-green-800 text-xs rounded-md font-medium border border-green-200" 
                                    ...
                                    @else
                                        <a href="{{ route('residence-data.create-account', $demographic->id) }}" 
                                           class="btn btn-sm bg-green-500 hover:bg-green-600 text-white px-3 py-2 rounded-md transition-colors duration-200 flex items-center gap-1"
                                           title="Create account for this resident (admin only)">
                                            <i data-lucide="user-plus" class="w-4 h-4"></i>
                                            <span class="text-xs">Create Account</span>
                                        </a>
                                    @endif
                                </div>
                            </td>

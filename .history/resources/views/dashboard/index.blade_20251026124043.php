...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="col-span-12 lg:col-span-6">
            <div class="intro-y box p-5">
                <h3 class="font-medium text-base mb-4">Scholar Status Overview</h3>
                <div class="relative h-64">
                    <canvas id="dashboardScholarChart"></canvas>
                </div>
            </div>
        </div>
        ...
        <div class="col-span-12 lg:col-span-6">
            <div class="intro-y box p-5">
                <h3 class="font-medium text-base mb-4">Disbursement Trend</h3>
                <div class="relative h-64">
                    <canvas id="dashboardDisbursementChart"></canvas>
                </div>
            </div>
        </div>
        ...
        <div class="col-span-12">
            <div class="intro-y box p-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <a href="{{ route('super-admin.analytics') }}" class="btn btn-outline-primary">
                        <i data-lucide="bar-chart-3" class="w-4 h-4 mr-2"></i> View Analytics
                    </a>

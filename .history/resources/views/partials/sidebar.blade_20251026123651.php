...
<nav class="side-nav">
    <ul>
        ...
        <!-- Super Admin Section -->
        <li>
            <a href="{{ route('super-admin.analytics') }}" class="side-menu {{ request()->routeIs('super-admin.analytics*') ? 'side-menu--active' : '' }}">
                <div class="side-menu__icon">
                    <i data-lucide="bar-chart-3"></i>
                </div>
                <div class="side-menu__title">Analytics Overview</div>
            </a>
        </li>
        <li>

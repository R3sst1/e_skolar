...
<div class="intro-y flex items-center mt-8">
    ...
    <a href="{{ route('feedback.admin.analytics') }}" class="btn btn-outline-primary">
        <i data-lucide="bar-chart" class="w-4 h-4 mr-2"></i> View Analytics
    </a>
</div>
            ...
            <div class="box p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <div class="text-lg font-medium">{{ $stats['total_feedback'] }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="box p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <div class="text-lg font-medium">{{ $stats['pending_review'] }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="box p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <div class="text-lg font-medium">{{ $stats['reviewed'] }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="box p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <div class="text-lg font-medium">{{ number_format($stats['average_rating'], 1) }}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="intro-y">
            <div class="box">
                <div class="p-5 border-b border-slate-200/60">
                    <h2 class="font-medium text-base">All Feedback</h2>
                </div>
                <div class="p-0">
                                ...
                                <tr class="intro-x">
                                    <td>
                                        <div class="font-medium">
                                            @if($feedback->anonymous)
                                                Anonymous
                                            @else
                                                {{ $feedback->scholar->user->first_name }} {{ $feedback->scholar->user->last_name }}
                                            @endif
                                        </div>
                                        @if($feedback->anonymous)
                                            <div class="text-slate-500 text-xs">Anonymous submission</div>
                                        @else
                                            <div class="text-slate-500 text-xs">{{ $feedback->scholar->user->email }}</div>
                                        @endif
                                    </td>
                                    <td>
                                    ...
                                    <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            <a href="{{ route('feedback.admin.show', $feedback->id) }}"
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-8">
                                        <div class="text-slate-500">
                                            ...
                                            <div class="text-sm">Scholar feedback will appear here</div>
                                        </div>
                                    </td>
                                </tr>
                                @endforelse

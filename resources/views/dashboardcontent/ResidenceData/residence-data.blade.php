...
<div class="max-w-7xl mx-auto p-4">
    ...
    <div class="mb-6 relative">
        ...
        <!-- Absolutely positioned button in top-right corner -->
                    ...
                    <table class="table table-report -mt-2">
                        <thead>
                            <tr>
                                ...
                                <th class="whitespace-nowrap">Validation Status</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(in_array($demographic->id, $validatedResidentIds ?? []))
                                        <div class="flex items-center text-success">
                                            <i data-lucide="check-circle" class="w-4 h-4 mr-1"></i>
                                    ...
                                    @else
                                        <div class="flex items-center text-warning">
                                            ...
                                            <span class="text-sm font-medium">⚠️ Not Validated</span>
                                        </div>
                                    @endif
                                </td>
                                <td>
                                        ...
                                        @if(!$existingUser)
                                            ...
                                            @else
                                                <button type="button" 
                                                        ...
                                                        title="User is not validated"
                                                        data-tw-toggle="modal" 
                                                        data-tw-target="#validation-modal-{{ $demographic->id }}">
                                                    <i data-lucide="user-plus" class="w-4 h-4"></i>
                                                </button>
                                            @endif
                                        @endif
...
@foreach($demographics as $demographic)
    @if(!in_array($demographic->id, $validatedResidentIds ?? []))
        <div id="validation-modal-{{ $demographic->id }}" class="modal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body text-center">
                        <div class="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-warning/20 mb-4">
                            <i data-lucide="alert-triangle" class="h-6 w-6 text-warning"></i>
                        </div>
                        <h3 class="text-lg font-medium text-slate-900 mb-2">User Not Validated</h3>
                        <p class="text-slate-600 mb-4">
                            The user <strong>{{ $demographic->full_name }}</strong> is not validated in the beneficiary system. 
                            Please ensure the user is properly validated before creating an account.
                        </p>
